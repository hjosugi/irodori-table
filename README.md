...
| `registry/`                  | Generated/app-consumed registry data: extension catalog, engine cheatsheets, support-status snapshots, and agent-workstream metadata.                                                                          |
...
| Doc/repo/archive ownership                                    | [repository-boundaries](https://hjosugi.github.io/irodori-docs/repository-boundaries.html)                                                                               |
